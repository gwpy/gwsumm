# -*- coding: utf-8 -*-
#
# GWSumm documentation build configuration file, created by
...
from gwsumm import version as gwsumm_version
...
intersphinx_mapping = {
    ...
    'gwpy': ('https://ldas-jobs.ligo.caltech.edu/~duncan.macleod/gwpy/html/',
             None),
}
